...
import { setCities } from "@/features/sliceCities";
...
const WeatherStatus = () => {
    ...
    return (_jsxs("div", { className: "flex flex-col lg:flex-row lg:justify-center ", children: [_jsxs("div", { className: "flex flex-col items-center lg:w-1/2", children: [_jsxs("div", { className: "flex gap-1", children: [_jsx("button", { onClick: handleSubmitButton, className: "flex items-center justify-center mt-8 bg-bg_input p-2 rounded-lg", children: _jsx("img", { src: cloud, alt: "" }) }), _jsx(Input, {})] }), cities.length > 0 ? (_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.5 }, children: cities.map((city) => {
                            ...
                            return (_jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, children: _jsx(WeatherCard, { backgroundImage: backgroundImage, iconImage: iconImage, date: date, time: time }) }, city.id));
                        }) })) : (_jsx("div", { className: "font-bold text-2xl flex items-center min-h-screen", children: error }))] }), _jsx("div", { className: "flex flex-col items-center lg:w-1/2", children: cities.length > 0 && (_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 0.5 }, children: cities.map((city) => (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.5 }, children: [_jsx(TableStatus, {}), _jsx(WeekWeather, {})] }, city.id))) })) })] }));
};
